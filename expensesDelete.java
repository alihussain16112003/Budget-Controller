...
public class expensesDelete extends JFrame implements ActionListener
{
	Button B;
	JPanel p;
	Choice ch ;
	...
	public expensesDelete()
	{
		...
		public void itemStateChanged(ItemEvent Aobj){
			try{
				...
				Connection Cobj = DriverManager.getConnection("jdbc:mysql://localhost/budget","root"," ");
				Statement sobj = Cobj.createStatement();
				ResultSet rsobj = sobj.executeQuery(" select ExpenseType,ExpenseAmount,Date from expenses where ID= '"+ch.getSelectedItem()+"';");
