...
public class Searchincome extends JFrame implements ActionListener
{
	Button B2,B3,B;
	JLabel l1, l2;
	Choice ch;
	...
	public void ShowSearch()
	{
		...
		j1.add(B);
			...
			try{
				...
				Connection Cobj = DriverManager.getConnection("jdbc:mysql://localhost/budget","root"," ");
				Statement sobj = Cobj.createStatement();
				ResultSet rsobj = sobj.executeQuery(" select ID,MemberCount,TotalIncome,Date from Income where ID= '"+ch.getSelectedItem()+"';");
