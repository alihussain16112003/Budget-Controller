...
public class expensescontroller extends JFrame implements ActionListener
{
	...
	public expensescontroller()
	{
		...
		JLabel title = new JLabel("Add Expenses");
		title.setBounds(140,20,220,40);
		title.setFont(new Font("Arial",Font.BOLD, 30));
		p.add(title);
		
		L1 = new JLabel("Expense Type");
	...
	public void addexpenses(expenses Eobj)
	{
		try
		{
			...
			String inputQry = "insert into expenses(ExpenseType,ExpenseAmount,Date) values(";
			inputQry += "'" + s +"',";
			inputQry += "" + s1 + ",";
			inputQry += "'" + a1 + "')";
